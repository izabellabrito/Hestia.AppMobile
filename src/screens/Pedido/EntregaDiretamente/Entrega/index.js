...
export default function EntregaDiretamente({ navigation, route }) {
	...
	async function atualizaStatus() {
		...
		await api
			.put(
				`/pedido/atualizar-status-pedido/${route.params.id}?statusNovo=2`,
				{},
				{
